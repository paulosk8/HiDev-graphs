...
- **Limitaciones actuales (conocidas)**: NO propaga borrados todavía; conflictos = última-escritura-gana (relojes distintos). Material (archivos) nunca sube: en otro equipo aparece el metadato pero el archivo falta.
