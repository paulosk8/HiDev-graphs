...
const api: PedagoGraphApi = {
  ...
  lienzosDeConcepto: (id) => ipcRenderer.invoke(CANALES.lienzosDeConcepto, id),
  obtenerLienzo: (id) => ipcRenderer.invoke(CANALES.lienzoObtener, id),
  crearLienzo: (nombre, contexto) => ipcRenderer.invoke(CANALES.lienzoCrear, nombre, contexto),
  ...
  registrarRepaso: (id, calidad) => ipcRenderer.invoke(CANALES.conceptoRepasar, id, calidad),
  ...
  agregarTermino: (conceptoId, datos) =>
    ipcRenderer.invoke(CANALES.conceptoTerminoAgregar, conceptoId, datos),
  editarTermino: (conceptoId, terminoId, datos) =>
    ipcRenderer.invoke(CANALES.conceptoTerminoEditar, conceptoId, terminoId, datos),
  eliminarTermino: (conceptoId, terminoId) =>
  ...
  editarAsignatura: (id, datos) => ipcRenderer.invoke(CANALES.asignaturaEditar, id, datos),
  ...
  vaciarEliminados: () => ipcRenderer.invoke(CANALES.eliminacionVaciar),
