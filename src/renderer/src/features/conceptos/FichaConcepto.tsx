...
import type { FichaConceptoDTO, ResumenLienzoDTO, ResumenMencionDTO } from '@shared/dtos'
...
import { PracticasConcepto } from './PracticasConcepto'
...
export function FichaConcepto({ conceptoId }: Props): JSX.Element {
  ...
  return (
    <div className="mx-auto max-w-3xl px-8 py-8">
      ...
      {/* Lo que se PIDE con el concepto va pegado a dónde se enseña: una
          práctica cuelga de un tema, así que la lista de arriba es justo lo
          que decide dónde puede ir la que se cree aquí. */}
      <PracticasConcepto concepto={concepto} usos={usos} />
